...
(custom-theme-set-faces
 ...
 '(org-level-1 ((t (:background "#000000" :foreground "#00bbff" :weight bold))))
 '(org-level-2 ((t (:background "#000000" :foreground "#00bb00" :weight bold))))
 '(org-level-3 ((t (:background "#000000" :foreground "#0000aa" :weight bold))))
 '(org-level-4 ((t (:background "#000000" :foreground "#ffaa00" :weight bold))))
 '(region ((nil (:background "#0000ff" :foreground "#FFFFFF" nil :weight bold)))))
