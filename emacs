...
(normal-top-level-add-to-load-path '("~/.elisp/web-mode") )
(normal-top-level-add-to-load-path '("~/.elisp/yasnippet") )
(normal-top-level-add-to-load-path '("~/.elisp/python/") )
(normal-top-level-add-to-load-path '("~/.elisp/python-django/") )
(normal-top-level-add-to-load-path '("~/.elisp/less") )
(normal-top-level-add-to-load-path '("~/.elisp/magit") )
(normal-top-level-add-to-load-path '("~/.elisp/yaml-mode") )
(normal-top-level-add-to-load-path '("~/.elisp/ack-el/") )
(normal-top-level-add-to-load-path '("~/.elisp/nxhtml/") )
(normal-top-level-add-to-load-path '("~/.elisp/dirtree/"))
(normal-top-level-add-to-load-path '("~/.elisp/nagios-mode/"))
(normal-top-level-add-to-load-path '("~/.elisp/ios-config-mode/"))

(load "~/.elisp/floobits/floobits.el")
